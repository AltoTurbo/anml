...
export interface UserProfile {
  ...
  lastPaymentDate?: string; // Formato YYYY-MM-DD
}
...
interface AuthContextType {
  ...
  registerUser: (email: string, password: string, name: string, phone: string, dni: string) => Promise<void>;
  loginUser: (email: string, password: string) => Promise<void>;
  logoutUser: () => Promise<void>;
  updateUserProfileDetails: (details: Partial<Pick<UserProfile, 'name' | 'specialty' | 'bio' | 'phone' | 'dni'>>) => Promise<void>;
}
...
export const AuthProvider = ({ children, redirectUrl }: { children: ReactNode, redirectUrl: string | null }) => {
  ...
  const registerUser = async (email: string, password: string, name: string, phone: string, dni: string) => {
    setLoading(true);
    try {
  ...
  const updateUserProfileDetails = async (details: Partial<Pick<UserProfile, 'name' | 'specialty' | 'bio' | 'phone' | 'dni'>>) => {
